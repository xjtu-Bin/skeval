 ...
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 */
  __pyx_tuple__24 = PyTuple_Pack(8, __pyx_n_s_img0, __pyx_n_s_img1, __pyx_n_s_max_dist, __pyx_n_s_outlier_cost, __pyx_n_s_i0, __pyx_n_s_i1, __pyx_n_s_o0, __pyx_n_s_o1); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 56, __pyx_L1_error)
